...
function createSlide(pres, theme, pageNum, totalPages) {
  ...
  slide.addText("认可项目价值，愿意配合 —— 但不会主动发起行动", {
  ...
  slide.addText("你推他就动，", {
    ...
    fontSize: 22, fontFace: FONT_CN, color: theme.white,
    bold: true, align: "left", valign: "middle"
  });
  slide.addText("你不推他就停", {
  ...
  slide.addText("不会对项目产生阻碍", {
    x: 0.7, y: 3.6, w: 4.0, h: 0.3,
    fontSize: 12, fontFace: FONT_CN, color: theme.white,
    align: "left", valign: "middle"
  });
  slide.addText("也不会主动创造推进力", {
    x: 0.7, y: 3.9, w: 4.0, h: 0.3,
    fontSize: 12, fontFace: FONT_CN, color: theme.white,
    align: "left", valign: "middle"
  });
  slide.addText("需要持续管理", {
  ...
  // 底部金句
  slide.addText("A2 是「合格的同盟军」，但不要误以为是 A1", {
