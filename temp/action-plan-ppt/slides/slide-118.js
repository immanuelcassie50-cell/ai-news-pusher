// slide-118.js - 协调摩擦：单页+例子
const pptxgen = require("pptxgenjs");
const { addFooterMark } = require("../design-system.js");

const slideConfig = { type: "friction-type", index: 118, title: "协调摩擦" };
...
function createSlide(pres, theme) {
  ...
  slide.addText("把依赖他人的环节提前或独立化 · 提前安排固定时间", {
  ...
  // 底部
  slide.addText("\"等待对方\"的环节越多，任务被卡住的概率越大", {
