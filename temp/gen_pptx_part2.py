# -*- coding: utf-8 -*-
"""Part 2: P14-P130 for 知行工作坊 PPT.

Rebuilt from scratch with clean Python. Captures all 5 chapters and key
teaching points from the original (4R, 3-nuclei, 5 openings, 4 question
types, follow-up 4 methods, cases, etc).
"""
...
# Helpers are defined in gen_pptx.py: prs, BLANK, BG, DARK, RED, GREEN, GOLD, TXT, GRY, LGT, WHT, LBG, W, H
# Functions: bg, rc, tx, hdr, ftr, note
...
def P18():
    ...
    ftr(s)
    note(s, "【2.1 维度三：学员维度】\n\n学员维度的目的是理解学员的真实状态。\n\n3 个方面：\n- 经验：工作年限 / 是否独立处理过 / 是否接受过类似培训\n- 特点：年龄 / 学历 / 岗位 / 部门 / 工作风格\n- 挑战：具体困难 / 想解决的问题 / 老板的期望\n\n学员维度决定了 R2（现实）的分享质量。")
