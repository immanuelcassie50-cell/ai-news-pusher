#!/usr/bin/env python3
"""Build complete blank workbook with all required files."""

import os
import shutil

SKILL_DIR = "C:/Users/Administrator/.claude/skills/Excel表格处理"
TEMPLATE_DIR = "/tmp/xlsx_complete"
...
# ---- Create styles.xml (minimal 13-style template) ----
...
strings = [
    ...
    "亦师亦友，关系比较健康",
    "像家人一样，形成强信任关系",
    # 61-75: Questions Q13-Q15 + interpretations
    "13. 您的变现模式是否可持续？",
    "不知道能不能继续，走一步看一步",
    "有点焦虑，担心模式会失效",
    "有规划，但还需要验证",
    ...
    "当前结构分析",
    "一次性vs持续性收入占比",
    # 260-279: Sheet 6 continued + Sheet 7
    "30天行动计划",
    "第1周：基础建设",
    "第2周：内容优化",
    "第3周：变现测试",
...
# ---- Helper to create a sheet XML ----
def create_sheet_xml(sheet_id, rows_data, col_count=6):
    """rows_data: list of (row_num, cells) where cells is list of (col_letter, type, value, style)"""
    col_widths = f'''  <cols>
    <col min="1" max="1" width="35" customWidth="1"/>
    <col min="2" max="{col_count}" width="16" customWidth="1"/>
  </cols>'''
...
sheet1_rows = [
    ...
    (5, [('A','s',11,0), ('B','n',2,1), ('C','n',2,1), ('D','n',2,1)]),
    ...
    (10, [('A','s',16,0)]),
    (11, [('A','s',31,0), ('B','n',3,1), ('C','n',3,1), ('D','n',3,1)]),
    (12, [('A','s',32,0), ('B','n',2,1), ('C','n',2,1), ('D','n',2,1)]),
    ...
    (16, [('A','s',36,0)]),
    (17, [('A','s',46,0), ('B','n',2,1), ('C','n',2,1), ('D','n',2,1)]),
...
sheet2_rows = [
    ...
    (4, [('A','s',87,0), ('B','n',7,1), ('C','n',6,1), ('D','n',8,1), ('E','n',9,1)]),
    (5, [('A','s',88,0), ('B','n',6,1), ('C','n',7,1), ('D','n',9,1), ('E','n',8,1)]),
    (6, [('A','s',89,0), ('B','n',5,1), ('C','n',9,1), ('D','n',7,1), ('E','n',6,1)]),
    (7, [('A','s',90,0), ('B','n',6,1), ('C','n',8,1), ('D','n',9,1), ('E','n',7,1)]),
    (8, [('A','s',91,0), ('B','n',8,1), ('C','n',5,1), ('D','n',6,1), ('E','n',9,1)]),
    (9, [('A','s',92,0), ('B','n',7,1), ('C','n',6,1), ('D','n',8,1), ('E','n',5,1)]),
    (10, [('A','s',93,0), ('B','n',6,1), ('C','n',7,1), ('D','n',5,1), ('E','n',8,1)]),
    (11, [('A','s',94,0), ('B','n',8,1), ('C','n',6,1), ('D','n',7,1), ('E','n',9,1)]),
    (12, [('A','s',95,0), ('B','n',5,1), ('C','n',7,1), ('D','n',9,1), ('E','n',6,1)]),
...
sheet3_rows = [
    ...
    (13, [('A','s',121,0), ('B','n',4,1)]),
    (14, [('A','s',122,0), ('B','n',3,1)]),
    (15, [('A','s',123,0), ('B','n',4,1)]),
    (16, [('A','s',124,0), ('B','n',5,1)]),
...
sheet4_rows = [
    ...
    (5, [('A','s',168,0), ('B','n',3,1), ('C','n',3,1), ('D','n',2,1), ('E','n',2,1)]),
    (6, [('A','s',169,0), ('B','n',3,1), ('C','n',3,1), ('D','n',2,1), ('E','n',2,1)]),
    (7, [('A','s',170,0), ('B','n',2,1), ('C','n',3,1), ('D','n',2,1), ('E','n',1,1)]),
    (8, [('A','s',171,0), ('B','n',3,1), ('C','n',2,1), ('D','n',2,1), ('E','n',1,1)]),
    (9, [('A','s',172,4), ('B','f','SUM(B5:B8)',6), ('C','f','SUM(C5:C8)',6), ('D','f','SUM(D5:D8)',6), ('E','f','SUM(E5:E8)',6)]),
    (10, [('A','s',173,4)]),
    (11, [('A','s',180,0), ('B','n',2,1), ('C','n',3,1), ('D','n',2,1), ('E','n',1,1)]),
    (12, [('A','s',181,0), ('B','n',3,1), ('C','n',2,1), ('D','n',2,1), ('E','n',1,1)]),
    (13, [('A','s',182,0), ('B','n',2,1), ('C','n',2,1), ('D','n',1,1), ('E','n',2,1)]),
    (14, [('A','s',183,0), ('B','n',3,1), ('C','n',2,1), ('D','n',1,1), ('E','n',1,1)]),
    (15, [('A','s',184,4), ('B','f','SUM(B11:B14)',6), ('C','f','SUM(C11:C14)',6), ('D','f','SUM(D11:D14)',6), ('E','f','SUM(E11:E14)',6)]),
    (16, [('A','s',185,4)]),
    (17, [('A','s',190,0), ('B','n',2,1), ('C','n',2,1), ('D','n',1,1), ('E','n',1,1)]),
    (18, [('A','s',191,0), ('B','n',2,1), ('C','n',2,1), ('D','n',1,1), ('E','n',1,1)]),
    (19, [('A','s',192,0), ('B','n',1,1), ('C','n',1,1), ('D','n',2,1), ('E','n',1,1)]),
    (20, [('A','s',193,0), ('B','n',2,1), ('C','n',1,1), ('D','n',1,1), ('E','n',2,1)]),
    (21, [('A','s',194,4), ('B','f','SUM(B17:B20)',6), ('C','f','SUM(C17:C20)',6), ('D','f','SUM(D17:D20)',6), ('E','f','SUM(E17:E20)',6)]),
    (22, [('A','s',195,4)]),
    (23, [('A','s',200,0), ('B','n',1,1), ('C','n',1,1), ('D','n',2,1), ('E','n',1,1)]),
    (24, [('A','s',201,0), ('B','n',1,1), ('C','n',2,1), ('D','n',1,1), ('E','n',1,1)]),
