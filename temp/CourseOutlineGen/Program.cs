...
body.Append(FourColTable(new[] {
    ("价值定位", "我们为谁创造什么价值？", "客户需求+自身能力匹配", "绘制价值定位画布"),
    ("能力定位", "我们的核心竞争力是什么？", "SWOT分析+价值链定位", "识别差异化优势"),
    ("关系定位", "我们与业务部门的关系？", "合作伙伴模型", "从配合到共创"),
    ("资源定位", "我们的核心资源是什么？", "资源能力分析", "资源整合与优化"),
}));
