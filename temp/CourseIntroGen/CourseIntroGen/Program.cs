...
// =============================================================================
// Course Introduction Document Generator
// 校招导师赋能——用一张画布构建深度辅导框架
// =============================================================================

var outputPath = @"D:/CC/temp/对外大纲（课程介绍）.docx";
...
void CreateStyles(Styles styles)
{
    ...
    titlePPr.Append(new SpacingBetweenLines { After = "80" });
    ...
    subtitlePPr.Append(new SpacingBetweenLines { After = "320" });
    ...
    h1.Append(new NextParagraphStyle { Val = "Normal" });
    ...
    h2.Append(new NextParagraphStyle { Val = "Normal" });
    ...
    h3.Append(new NextParagraphStyle { Val = "Normal" });
    ...
    listPPr.Append(new SpacingBetweenLines { After = "60", Before = "0" });
    ...
    quotePPr.Append(new SpacingBetweenLines { After = "200", Before = "200" });
    ...
    notePPr.Append(new SpacingBetweenLines { After = "160" });
    note.Append(notePPr);
