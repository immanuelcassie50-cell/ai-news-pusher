// slide-06.js - 失效信号一：任务导向 vs 价值导向
const pptxgen = require("pptxgenjs");

const slideConfig = {
  type: 'content',
  index: 6,
  title: '失效信号一：任务导向 vs 价值导向'
};
...
function createSlide(pres, theme) {
  ...
  // 页面标题
  slide.addText("失效信号一：任务导向 vs 价值导向", {
  ...
  slide.addText([
    { text: '"计划完成了吗？"', options: { bullet: true, breakLine: true } },
    { text: '"流程都走了吗？"', options: { bullet: true, breakLine: true } },
    { text: '"领导交代的事办了吗？"', options: { bullet: true } }
  ], {
  ...
  slide.addText([
    { text: '"这个动作创造什么价值？"', options: { bullet: true, breakLine: true } },
    { text: '"能否用更少资源达成目标？"', options: { bullet: true, breakLine: true } },
    { text: '"如何衡量最终效果？"', options: { bullet: true } }
  ], {
...
if (require.main === module) {
  ...
  pres.writeFile({ fileName: "D:/新课开发/电力/9-中层管理者经营力提升从行政管理到真经营/05-授课PPT/slides/slide-06-preview.pptx" })
