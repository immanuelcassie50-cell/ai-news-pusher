...
function createSlide(pres, theme) {
  ...
  // 核心功能
  const functions = [
    { icon: "🧠", title: "知识整理", desc: "帮你把碎片信息结构化，形成知识体系" },
    { icon: "📝", title: "内容提炼", desc: "从长篇内容中提取核心观点和关键论据" },
    { icon: "🔗", title: "关联分析", desc: "发现不同信息之间的联系和规律" }
  ];
  ...
  slide.addText("适用：信息太多太杂，需要梳理脉络、形成框架时", {
    x: 0.5, y: 5.05, w: 9, h: 0.5,
    fontSize: 14, fontFace: "Microsoft YaHei",
    color: "FFFFFF",
    align: "center", valign: "middle"
...
if (require.main === module) {
  ...
  pres.writeFile({ path: "D:/CC/temp/ppt-slides/slide-32-output.pptx" })
    .then(() => console.log("Created: slide-32-output.pptx"))
