...
if (require.main === module) {
  ...
  pres.writeFile({ path: "D:/CC/temp/ppt-slides/slide-24-output.pptx" })
    .then(() => console.log("Created: slide-24-output.pptx"))
