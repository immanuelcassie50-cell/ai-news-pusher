...
function createSlide(pres, theme) {
  ...
  slide.addText("第六章", { x: 0.3, y: 0.3, w: 1.5, h: 0.5, fontSize: 18, fontFace: "Microsoft YaHei", color: "FFFFFF", bold: true, align: "center", valign: "middle" });
  slide.addText("60分钟", { x: 1.9, y: 0.35, w: 0.8, h: 0.4, fontSize: 12, fontFace: "Microsoft YaHei", color: theme.accent });

  slide.addText("报价是信任浓度的显示器", { x: 0.3, y: 0.95, w: 9.4, h: 0.6, fontSize: 24, fontFace: "Microsoft YaHei", color: theme.primary, bold: true });

  slide.addShape(pres.shapes.RECTANGLE, { x: 0.3, y: 1.65, w: 9.4, h: 0.7, fill: { color: theme.light } });
  slide.addText("客户压你的价，压的往往不是钱，是他对这次合作有没有把握。", { x: 0.5, y: 1.7, w: 9, h: 0.6, fontSize: 13, fontFace: "Microsoft YaHei", color: theme.primary, bold: true, align: "center", valign: "middle" });

  slide.addText("核心概念", { x: 0.3, y: 2.5, w: 4.5, h: 0.4, fontSize: 14, fontFace: "Microsoft YaHei", color: theme.primary, bold: true });
  slide.addText([
    { text: "报价博弈=确定感 vs 价格让步", options: { bullet: true, breakLine: true } },
    { text: "信任浓度决定压价动力", options: { bullet: true, breakLine: true } },
    { text: "价格让步的陷阱", options: { bullet: true } }
  ...
  slide.addText([
    { text: '"信任浓度"判断清单', options: { bullet: true, breakLine: true } },
    { text: '提高"确定感"四步法', options: { bullet: true } }
  ...
  slide.addText("报价黄灯识别 / 报价话术设计", { x: 1.3, y: 4.0, w: 5, h: 0.35, fontSize: 11, fontFace: "Microsoft YaHei", color: theme.secondary });
