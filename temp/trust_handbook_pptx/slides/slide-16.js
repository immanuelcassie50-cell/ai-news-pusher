...
function createSlide(pres, theme) {
  ...
  slide.addText("第十二章", { x: 0.3, y: 0.3, w: 1.5, h: 0.5, fontSize: 18, fontFace: "Microsoft YaHei", color: "FFFFFF", bold: true, align: "center", valign: "middle" });
  slide.addText("60分钟", { x: 1.9, y: 0.35, w: 0.8, h: 0.4, fontSize: 12, fontFace: "Microsoft YaHei", color: theme.primary });

  slide.addText("讲台下的样子决定讲台上还有没有人再请你", { x: 0.3, y: 0.95, w: 9.4, h: 0.6, fontSize: 22, fontFace: "Microsoft YaHei", color: theme.accent, bold: true });

  slide.addShape(pres.shapes.RECTANGLE, { x: 0.3, y: 1.65, w: 9.4, h: 0.7, fill: { color: theme.light } });
  slide.addText("客户请你回来，不是因为你上一次讲得多精彩，是因为你在讲台之外，也是个说话算话的人。", { x: 0.5, y: 1.7, w: 9, h: 0.6, fontSize: 12, fontFace: "Microsoft YaHei", color: theme.accent, bold: true, align: "center", valign: "middle" });

  slide.addText("核心概念", { x: 0.3, y: 2.5, w: 4.5, h: 0.4, fontSize: 14, fontFace: "Microsoft YaHei", color: theme.accent, bold: true });
  slide.addText([
    { text: "信任积累最密集的地方：承诺兑现", options: { bullet: true, breakLine: true } },
    { text: "承诺轮廓管理", options: { bullet: true, breakLine: true } },
    { text: "小承诺的大影响", options: { bullet: true } }
  ...
  slide.addText([
    { text: "承诺管理三原则", options: { bullet: true, breakLine: true } },
    { text: "课后跟进清单", options: { bullet: true } }
  ...
  slide.addText('"我的承诺记录"审计 / 承诺话术实战', { x: 1.3, y: 4.0, w: 5, h: 0.35, fontSize: 11, fontFace: "Microsoft YaHei", color: theme.secondary });
