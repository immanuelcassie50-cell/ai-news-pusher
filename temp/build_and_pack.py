#!/usr/bin/env python3
"""Build and pack the complete blank workbook."""
...
sheet1_rows = [
    ...
    (10, [('A','s',16,0)]),
    (11, [('A','s',31,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1)]),
    (12, [('A','s',32,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1)]),
    (13, [('A','s',33,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1)]),
    (14, [('A','s',34,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1)]),
    (15, [('A','s',35,4), ('B','f','SUM(B11:B14)',6), ('C','f','SUM(C11:C14)',6), ('D','f','SUM(D11:D14)',6)]),
    (16, [('A','s',36,0)]),
    (17, [('A','s',46,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1)]),
    (18, [('A','s',47,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1)]),
    (19, [('A','s',48,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1)]),
    (20, [('A','s',49,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1)]),
    (21, [('A','s',50,4), ('B','f','SUM(B17:B20)',6), ('C','f','SUM(C17:C20)',6), ('D','f','SUM(D17:D20)',6)]),
    (22, [('A','s',51,0)]),
    (23, [('A','s',61,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1)]),
    (24, [('A','s',62,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1)]),
...
sheet2_rows = [
    ...
    (4, [('A','s',87,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (5, [('A','s',88,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (6, [('A','s',89,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (7, [('A','s',90,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (8, [('A','s',91,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (9, [('A','s',92,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (10, [('A','s',93,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (11, [('A','s',94,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (12, [('A','s',95,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
...
sheet3_rows = [
    ...
    (11, [('A','s',110,4)]),
    (12, [('A','s',120,0), ('B','n',1,1)]),
    (13, [('A','s',121,0), ('B','n',1,1)]),
    (14, [('A','s',122,0), ('B','n',1,1)]),
    (15, [('A','s',123,0), ('B','n',1,1)]),
    (16, [('A','s',124,0), ('B','n',1,1)]),
    (17, [('A','s',125,4), ('B','f','SUM(B12:B16)',6)]),
    (18, [('A','s',126,4)]),
    (19, [('A','s',140,0), ('B','n',1,1)]),
    (20, [('A','s',141,0), ('B','n',1,1)]),
    (21, [('A','s',142,0), ('B','n',1,1)]),
    (22, [('A','s',143,0), ('B','n',1,1)]),
    (23, [('A','s',144,0), ('B','n',1,1)]),
...
sheet4_rows = [
    ...
    (5, [('A','s',168,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (6, [('A','s',169,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (7, [('A','s',170,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (8, [('A','s',171,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (9, [('A','s',172,4), ('B','f','SUM(B5:B8)',6), ('C','f','SUM(C5:C8)',6), ('D','f','SUM(D5:D8)',6), ('E','f','SUM(E5:E8)',6)]),
    (10, [('A','s',173,4)]),
    (11, [('A','s',180,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (12, [('A','s',181,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (13, [('A','s',182,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (14, [('A','s',183,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (15, [('A','s',184,4), ('B','f','SUM(B11:B14)',6), ('C','f','SUM(C11:C14)',6), ('D','f','SUM(D11:D14)',6), ('E','f','SUM(E11:E14)',6)]),
    (16, [('A','s',185,4)]),
    (17, [('A','s',190,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (18, [('A','s',191,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (19, [('A','s',192,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (20, [('A','s',193,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (21, [('A','s',194,4), ('B','f','SUM(B17:B20)',6), ('C','f','SUM(C17:C20)',6), ('D','f','SUM(D17:D20)',6), ('E','f','SUM(E17:E20)',6)]),
    (22, [('A','s',195,4)]),
    (23, [('A','s',200,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
    (24, [('A','s',201,0), ('B','n',1,1), ('C','n',1,1), ('D','n',1,1), ('E','n',1,1)]),
...
sheet5_rows = [
    ...
    (8, [('A','s',247,0)]),
    (9, [('A','s',248,0), ('B','n',0,1), ('C','n',0,1), ('D','n',0,1), ('E','n',0,1)]),
    (10, [('A','s',249,0), ('B','n',0,1), ('C','n',0,1), ('D','n',0,1), ('E','n',0,1)]),
    (11, [('A','s',250,0), ('B','n',0,1), ('C','n',0,1), ('D','n',0,1), ('E','n',0,1)]),
    (12, [('A','s',251,0), ('B','n',0,1), ('C','n',0,1), ('D','n',0,1), ('E','n',0,1)]),
]
...
sheet6_rows = [
    ...
    (4, [('A','s',258,0), ('B','n',0,1), ('C','s',259,0)]),
    (5, [('A','s',260,0), ('B','n',0,1), ('C','s',261,0)]),
    (6, [('A','s',262,0), ('B','n',0,1), ('C','s',259,0)]),
    (7, [('A','s',263,0), ('B','n',0,1), ('C','s',261,0)]),
    (8, [('A','s',264,0), ('B','n',0,1), ('C','s',259,0)]),
    (9, [('A','s',265,0), ('B','n',0,1), ('C','s',261,0)]),
...
sheet7_rows = [
    ...
    (11, [('A','s',284,4)]),
    (12, [('A','s',285,0), ('B','n',0,1), ('C','s',286,0)]),
    (13, [('A','s',287,0), ('B','n',0,1), ('C','s',288,0)]),
    (14, [('A','s',289,0), ('B','n',0,1)]),
    (15, [('A','s',290,0)]),
    ...
    (24, [('A','s',284,4)]),
    (25, [('A','s',285,0), ('B','n',0,1), ('C','s',286,0)]),
    (26, [('A','s',287,0), ('B','n',0,1), ('C','s',288,0)]),
    (27, [('A','s',289,0), ('B','n',0,1)]),
    (28, [('A','s',290,0)]),
    ...
    (37, [('A','s',284,4)]),
    (38, [('A','s',285,0), ('B','n',0,1), ('C','s',286,0)]),
    (39, [('A','s',287,0), ('B','n',0,1), ('C','s',288,0)]),
    (40, [('A','s',289,0), ('B','n',0,1)]),
    (41, [('A','s',290,0)]),
    ...
    (50, [('A','s',284,4)]),
    (51, [('A','s',285,0), ('B','n',0,1), ('C','s',286,0)]),
    (52, [('A','s',287,0), ('B','n',0,1), ('C','s',288,0)]),
    (53, [('A','s',289,0), ('B','n',0,1)]),
    (54, [('A','s',290,0)]),
]
...
# Pack using zip
output_path = "D:/新课开发/自媒体/04商业化变现-从流量到留量的转化路径设计/配套表单和指引-Excel版/配套表单_空表.xlsx"
