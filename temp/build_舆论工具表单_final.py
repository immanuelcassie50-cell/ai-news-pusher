...
21 sheets covering 7 forms - Final version with proper path handling
"""
...
output_path = os.path.join(OUT_DIR, '工具表单集.xlsx')

# Use subprocess with shell=True for proper path handling on Windows
result = subprocess.run(
    ['python3', SKILL_DIR + '/scripts/xlsx_pack.py', work_dir, output_path],
    capture_output=True,
    text=True
)
