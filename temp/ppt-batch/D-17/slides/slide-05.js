...
function createSlide(pres, theme) {
  ...
  slide.addText([
    ...
    { text: "  痛点抓得准，5 维覆盖超出预期。", options: { fontSize: 13, color: theme.secondary, breakLine: true } },
    { text: "AI 方法论（30%）：", options: { fontSize: 13, color: theme.primary, bold: true, breakLine: true } },
    { text: "  四段式结构完整，约束中明确脱敏要求。", options: { fontSize: 13, color: theme.secondary, breakLine: true } },
    { text: "大众评审（20%）：", options: { fontSize: 13, color: theme.primary, bold: true, breakLine: true } },
    { text: "  我试用过，1 个下午就能用。", options: { fontSize: 13, color: theme.secondary, breakLine: true } },
    { text: "综合得分：", options: { fontSize: 13, color: theme.primary, bold: true } },
    { text: "  23.5 / 25", options: { fontSize: 16, color: theme.accent, bold: true } }
  ], {
