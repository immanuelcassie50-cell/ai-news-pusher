...
const slide01 = `// slide-01.js - Section Divider: 04 幻觉与边界
...
const slide02 = `// slide-02.js - Content: 什么是AI幻觉？
const pptxgen = require('pptxgenjs');
...
function createSlide(pres, theme) {
  ...
  slide.addText('基于事实、可验证知识库中的正确内容', {
  ...
  slide.addText('看似合理、实为错误模型自信地编造答案', {
...
// Write all files
fs.writeFileSync(path.join(slidesDir, 'slide-01.js'), slide01);
console.log('Written slide-01.js');

fs.writeFileSync(path.join(slidesDir, 'slide-02.js'), slide02);
console.log('Written slide-02.js');
...
console.log('All 5 slides written successfully!');
