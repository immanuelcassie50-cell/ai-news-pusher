...
string fontEastAsia = "Microsoft YaHei";
string fontAscii = "Arial";
string colorAccent = "C41E3A";  // Deep red
string colorDark = "8B0000";    // Dark red
string colorText = "333333";

// ============================================================
// Helper: Create RunProperties
// ============================================================
RunProperties MakeRp(string fontSize = "24", bool bold = false, string color = null, string fontEA = null, string fontAscii = null)
{
    var rp = new RunProperties();
    rp.AppendChild(new RunFonts {
        EastAsia = fontEA ?? fontEastAsia,
        Ascii = fontAscii ?? fontAscii,
        HighAnsi = fontAscii ?? fontAscii,
        ComplexScript = fontAscii ?? fontAscii
    });
...
// ============================================================
Paragraph MakeParagraph(string text, string styleId = "Normal", RunProperties rp = null, JustificationValues? jc = null)
{
    var p = new Paragraph();
    if (styleId != null) p.AppendChild(new ParagraphProperties(new ParagraphStyleId { Val = styleId }));
    if (jc.HasValue) {
        var pPr = p.GetFirstChild<ParagraphProperties>() ?? new ParagraphProperties();
        pPr.AppendChild(new Justification { Val = jc.Value });
    }
    var run = new Run();
    if (rp != null) foreach (var child in rp.ChildElements) run.AppendChild(child.CloneNode(true));
...
// ============================================================
// Helper: Shading (background color block)
// ============================================================
Paragraph ColorBlock(string text, string bgColor, string textColor = "FFFFFF", string fontSize = "24", bool bold = true)
{
    var p = new Paragraph();
    var pPr = new ParagraphProperties();
    var shading = new Shading { Val = ShadingPatternValues.Clear, Color = "auto", Fill = bgColor };
    pPr.AppendChild(shading);
    pPr.AppendChild(new SpacingBetweenLines { Before = "60", After = "60", Line = "360", LineRule = LineSpacingRuleValues.Auto });
    pPr.AppendChild(new Justification { Val = JustificationValues.Center });
    p.AppendChild(pPr);

    var rp = new RunProperties();
    rp.AppendChild(new RunFonts { EastAsia = fontEastAsia, Ascii = fontAscii, HighAnsi = fontAscii });
    ...
    var run = new Run();
    foreach (var child in rp.ChildElements) run.AppendChild(child.CloneNode(true));
    run.AppendChild(new Text(text) { Space = SpaceProcessingModeValues.Preserve });
    p.AppendChild(run);
    return p;
}
...
Paragraph Heading(string num, string title, string goldQuote = null)
{
    var p = new Paragraph();
    var pPr = new ParagraphProperties();
    pPr.AppendChild(new ParagraphStyleId { Val = "Heading1" });
...
// Helper: Bullet point
// ============================================================
Paragraph BulletPara(string text, int level = 0)
{
    var p = new Paragraph();
    var pPr = new ParagraphProperties();
...
// ============================================================
// Helper: Numbered para
// ============================================================
Paragraph NumberedPara(string num, string text)
{
    var p = new Paragraph();
    var pPr = new ParagraphProperties();
    ...
    var rp = MakeRp("24", false, colorText);
    var run = new Run(); foreach (var c in rp.ChildElements) run.AppendChild(c.CloneNode(true));
    run.AppendChild(new Text(num + "  " + text) { Space = SpaceProcessingModeValues.Preserve });
    p.AppendChild(run);
    return p;
}

// ============================================================
// Helper: Q&A item (question + answer)
// ============================================================
...
sectPr.AppendChild(new PageSize { Width = 16838, Height = 11906 }); // A4 landscape? No, let's use A4
sectPr.AppendChild(new PageSize { Width = 11906, Height = 16838 }); // A4 portrait
...
string MakeStyleId(string baseName, int outlineLevel, string fontSize, bool bold, string color, string basedOn = "Normal")
{
    string sid = baseName;
    var style = new Style { Type = StyleValues.Paragraph, StyleId = sid };
    style.AppendChild(new StyleName { Val = baseName });
    style.AppendChild(new BasedOn { Val = basedOn });
    style.AppendChild(new StyleParagraphProperties(
        new SpacingBetweenLines { Before = "200", After = "120", Line = "320", LineRule = LineSpacingRuleValues.Auto },
        new Justification { Val = JustificationValues.Left },
        new OutlineLevel { Val = outlineLevel }
    ));
    var rpr = new StyleRunProperties();
    rpr.AppendChild(new RunFonts { EastAsia = fontEastAsia, Ascii = fontAscii, HighAnsi = fontAscii });
...
nrpr.AppendChild(new RunFonts { EastAsia = fontEastAsia, Ascii = fontAscii, HighAnsi = fontAscii });
...
h1rpr.AppendChild(new RunFonts { EastAsia = fontEastAsia, Ascii = fontAscii, HighAnsi = fontAscii });
...
h2rpr.AppendChild(new RunFonts { EastAsia = fontEastAsia, Ascii = fontAscii, HighAnsi = fontAscii });
...
h3rpr.AppendChild(new RunFonts { EastAsia = fontEastAsia, Ascii = fontAscii, HighAnsi = fontAscii });
...
// Top accent bar
for (int i = 0; i < 3; i++) body.AppendChild(ColorBlock("", colorAccent, "FFFFFF", "12"));
...
pPr1.AppendChild(new SpacingBetweenLines { Before = "600", After = "200" });
coverTitle.AppendChild(pPr1);
var rpT = new RunProperties();
rpT.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
rpT.AppendChild(new Bold());
rpT.AppendChild(new Color { Val = colorDark });
rpT.AppendChild(new FontSize { Val = "72" });
rpT.AppendChild(new FontSizeComplexScript { Val = "72" });
var runT = new Run(); foreach (var c in rpT.ChildElements) runT.AppendChild(c.CloneNode(true));
runT.AppendChild(new Text("客户隐性需求") { Space = SpaceProcessingModeValues.Preserve });
coverTitle.AppendChild(runT);
...
pPr2.AppendChild(new SpacingBetweenLines { Before = "0", After = "400" });
coverTitle2.AppendChild(pPr2);
var runT2 = new Run(); foreach (var c in rpT.ChildElements) runT2.AppendChild(c.CloneNode(true));
runT2.AppendChild(new Text("挖掘与验证") { Space = SpaceProcessingModeValues.Preserve });
coverTitle2.AppendChild(runT2);
body.AppendChild(coverTitle2);

// Subtitle
var sub = new Paragraph();
var pPrS = new ParagraphProperties();
pPrS.AppendChild(new Justification { Val = JustificationValues.Center });
pPrS.AppendChild(new SpacingBetweenLines { Before = "100", After = "300" });
sub.AppendChild(pPrS);
var rpS = new RunProperties();
rpS.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
rpS.AppendChild(new Color { Val = "666666" });
rpS.AppendChild(new FontSize { Val = "28" });
rpS.AppendChild(new FontSizeComplexScript { Val = "28" });
var runS = new Run(); foreach (var c in rpS.ChildElements) runS.AppendChild(c.CloneNode(true));
runS.AppendChild(new Text("写给产品、销售与客户成功团队") { Space = SpaceProcessingModeValues.Preserve });
sub.AppendChild(runS);
...
qrPr.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
...
qRun.AppendChild(new Text("那些客户不会写进需求文档，却决定这单能不能成、\n这个客户能不能留住的东西") { Space = SpaceProcessingModeValues.Preserve });
...
var aPr = new ParagraphProperties();
aPr.AppendChild(new Justification { Val = JustificationValues.Center });
aPr.AppendChild(new SpacingBetweenLines { Before = "300", After = "100" });
authorP.AppendChild(aPr);
var arPr = new RunProperties();
arPr.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
...
ttRPr.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
...
foreach (var entry in tocEntries)
{
    ...
    if (!isPart) tPPr.AppendChild(new Indentation { Left = "360" });
    else tPPr.AppendChild(new Indentation { Left = "720" });
    tocP.AppendChild(tPPr);
    var tRPr = new RunProperties();
    tRPr.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
    tRPr.AppendChild(new Bold { Val = !isPart });
    ...
    tocP.AppendChild(tRun);
    body.AppendChild(tocP);
}
...
// ============================================================
body.AppendChild(ColorBlock("第一章  课程导论", colorAccent, "FFFFFF", "28"));
...
// ============================================================
body.AppendChild(ColorBlock("第二章  如何使用本手册", colorAccent, "FFFFFF", "28"));
body.AppendChild(BodyPara(""));
...
// ============================================================
body.AppendChild(ColorBlock("第三章  学习路径图", colorAccent, "FFFFFF", "28"));
body.AppendChild(BodyPara(""));
...
foreach (var ch in part1Chapters)
{
    var p = new Paragraph();
    var pPr = new ParagraphProperties();
    pPr.AppendChild(new SpacingBetweenLines { Before = "60", After = "60", Line = "280", LineRule = LineSpacingRuleValues.Auto });
    pPr.AppendChild(new Indentation { Left = "360" });
    p.AppendChild(pPr);
    var rPr = new RunProperties();
    rPr.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
    rPr.AppendChild(new Color { Val = "444444" });
    rPr.AppendChild(new FontSize { Val = "22" });
    rPr.AppendChild(new FontSizeComplexScript { Val = "22" });
    var run = new Run(); foreach (var c in rPr.ChildElements) run.AppendChild(c.CloneNode(true));
    run.AppendChild(new Text(ch) { Space = SpaceProcessingModeValues.Preserve });
    p.AppendChild(run);
    body.AppendChild(p);
}
...
foreach (var ch in part2Chapters)
{
    var p = new Paragraph();
    var pPr = new ParagraphProperties();
    pPr.AppendChild(new SpacingBetweenLines { Before = "60", After = "60", Line = "280", LineRule = LineSpacingRuleValues.Auto });
...
// ============================================================
body.AppendChild(ColorBlock("第四章  正文内容", colorAccent, "FFFFFF", "28"));
body.AppendChild(BodyPara(""));

// PART 1 Banner
var partBanner1 = new Paragraph();
var bpPr = new ParagraphProperties();
bpPr.AppendChild(new Justification { Val = JustificationValues.Center });
bpPr.AppendChild(new SpacingBetweenLines { Before = "200", After = "200" });
partBanner1.AppendChild(bpPr);
var bpRPr = new RunProperties();
bpRPr.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
bpRPr.AppendChild(new Bold());
bpRPr.AppendChild(new Color { Val = "FFFFFF" });
bpRPr.AppendChild(new FontSize { Val = "32" });
bpRPr.AppendChild(new FontSizeComplexScript { Val = "32" });
var bpRun = new Run(); foreach (var c in bpRPr.ChildElements) bpRun.AppendChild(c.CloneNode(true));
bpRun.AppendChild(new Text("PART 1  挖掘与验证的方法") { Space = SpaceProcessingModeValues.Preserve });
partBanner1.AppendChild(bpRun);

var pBannerBg = new Paragraph();
var pBgPPr = new ParagraphProperties();
pBgPPr.AppendChild(new Justification { Val = JustificationValues.Center });
pBgPPr.AppendChild(new Shading { Val = ShadingPatternValues.Clear, Color = "auto", Fill = "C41E3A" });
pBgPPr.AppendChild(new SpacingBetweenLines { Before = "200", After = "200" });
pBannerBg.AppendChild(pBgPPr);
var bgRPr = new RunProperties();
bgRPr.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
bgRPr.AppendChild(new Bold());
bgRPr.AppendChild(new Color { Val = "FFFFFF" });
bgRPr.AppendChild(new FontSize { Val = "32" });
bgRPr.AppendChild(new FontSizeComplexScript { Val = "32" });
var bgRun = new Run(); foreach (var c in bgRPr.ChildElements) bgRun.AppendChild(c.CloneNode(true));
bgRun.AppendChild(new Text("PART 1  挖掘与验证的方法") { Space = SpaceProcessingModeValues.Preserve });
pBannerBg.AppendChild(bgRun);
body.AppendChild(pBannerBg);
body.AppendChild(BodyPara(""));
...
body.AppendChild(BodyPara("我们习惯把客户表现出的谨慎、犹豫、反复确认理解成个人性格特质，觉得这个人天生保守、不好合作，然后在方案设计里绕开他，或者干脆换个更容易沟通的对接人。这个判断经常是错的。风险规避倾向绝大多数时候不是性格决定的，是岗位曾经承受过的责任压力决定的——一个在预算超支被通报批评过的采购负责人，会对任何超出预算的方案格外敏感。"));
body.AppendChild(BodyPara("挖掘风险规避偏好，有效的做法不是去问\"你担心什么风险\"，这个问题太直接，对方大概率会用一个体面的答案敷衍过去，比如\"稳妥一点总是好的\"。更有效的做法是观察他对哪一类问题反应最激烈，哪怕这类问题在你看来无关紧要。如果一个人对交付时间的延误容忍度很高，却对一次小小的数据误差反应极其强烈，这个反差本身就是信号。"));
...
body.AppendChild(BodyPara("有一次做需求优先级排序，团队按照标准的\"重要性/紧急性\"矩阵把功能列了一遍，排在最前面的是数据分析看板，因为它对业务价值的提升最大。方案提给客户之后，对方却坚持要求先做权限管理模块，理由含糊，说是\"更基础\"。团队一开始觉得客户没抓住重点，后来才明白，客户所在的部门刚经历过一次数据泄露事件被内部通报，权限管理对他们来说不是\"更基础\"，是\"更安全\"——这个安全指的是他这个岗位不会再因为类似事件被问责的安全。"));
...
// PART 2 Banner
var pBanner2 = new Paragraph();
var pB2PPr = new ParagraphProperties();
pB2PPr.AppendChild(new Justification { Val = JustificationValues.Center });
pB2PPr.AppendChild(new Shading { Val = ShadingPatternValues.Clear, Color = "auto", Fill = "8B0000" });
pB2PPr.AppendChild(new SpacingBetweenLines { Before = "200", After = "200" });
pBanner2.AppendChild(pB2PPr);
var pB2RPr = new RunProperties();
pB2RPr.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
pB2RPr.AppendChild(new Bold());
pB2RPr.AppendChild(new Color { Val = "FFFFFF" });
pB2RPr.AppendChild(new FontSize { Val = "32" });
pB2RPr.AppendChild(new FontSizeComplexScript { Val = "32" });
var pB2Run = new Run(); foreach (var c in pB2RPr.ChildElements) pB2Run.AppendChild(c.CloneNode(true));
pB2Run.AppendChild(new Text("PART 2  这份工作最终练的是什么") { Space = SpaceProcessingModeValues.Preserve });
pBanner2.AppendChild(pB2Run);
body.AppendChild(pBanner2);
body.AppendChild(BodyPara(""));
...
body.AppendChild(BodyPara("我自己是从一次很难堪的经历里想明白这件事的。有个客户在项目中期突然情绪很大，指责我们完全没理解他们的需求，我当时很委屈，因为需求文档上的每一条我们都按时完成了，甚至超出预期。后来冷静下来想，他愤怒的点从来不是那份文档，是他之前跟我提过一句\"我们团队现在压力很大，希望这个项目能减轻一点负担\"，这句话我记在了会议纪要里，但没有真正把它当成一个需要被回应的诉求，只当成一句场面话。那次之后我才明白，客户很多时候不是在气产品做得不够好，是在气那句话说出口之后，没人真正接住。"));
...
// CHAPTER 5: DEEP Q&A
// ============================================================
body.AppendChild(ColorBlock("第五章  深度问答", colorAccent, "FFFFFF", "28"));
body.AppendChild(BodyPara(""));

// PART 1 Q&A
var qaBanner1 = new Paragraph();
var qaB1PPr = new ParagraphProperties();
qaB1PPr.AppendChild(new SpacingBetweenLines { Before = "200", After = "100" });
qaB1PPr.AppendChild(new Shading { Val = ShadingPatternValues.Clear, Color = "auto", Fill = "F5F0F0" });
qaBanner1.AppendChild(qaB1PPr);
var qaB1RPr = new RunProperties();
qaB1RPr.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
qaB1RPr.AppendChild(new Bold());
qaB1RPr.AppendChild(new Color { Val = "C41E3A" });
qaB1RPr.AppendChild(new FontSize { Val = "26" });
var qaB1Run = new Run(); foreach (var c in qaB1RPr.ChildElements) qaB1Run.AppendChild(c.CloneNode(true));
qaB1Run.AppendChild(new Text("PART 1  精选问答（5题）") { Space = SpaceProcessingModeValues.Preserve });
qaBanner1.AppendChild(qaB1Run);
body.AppendChild(qaBanner1);
...
// PART 2 Q&A
var qaBanner2 = new Paragraph();
var qaB2PPr = new ParagraphProperties();
qaB2PPr.AppendChild(new SpacingBetweenLines { Before = "300", After = "100" });
qaB2PPr.AppendChild(new Shading { Val = ShadingPatternValues.Clear, Color = "auto", Fill = "F0F0F5" });
qaBanner2.AppendChild(qaB2PPr);
var qaB2RPr = new RunProperties();
qaB2RPr.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
qaB2RPr.AppendChild(new Bold());
qaB2RPr.AppendChild(new Color { Val = "8B0000" });
qaB2RPr.AppendChild(new FontSize { Val = "26" });
var qaB2Run = new Run(); foreach (var c in qaB2RPr.ChildElements) qaB2Run.AppendChild(c.CloneNode(true));
qaB2Run.AppendChild(new Text("PART 2  精选问答（5题）") { Space = SpaceProcessingModeValues.Preserve });
qaBanner2.AppendChild(qaB2Run);
body.AppendChild(qaBanner2);
...
// CHAPTER 6: TOOLKIT
// ============================================================
body.AppendChild(ColorBlock("第六章  工具包", colorAccent, "FFFFFF", "28"));
body.AppendChild(BodyPara(""));

// Toolkit Intro
body.AppendChild(BodyPara("本工具包是《客户隐性需求挖掘与验证》课程的配套实操材料，使用时请结合手册正文中的判断逻辑，不建议脱离正文单独套用。"));

// Section 1: Interview Scripts
...
// Section 2: Verification Experiment
...
// CHAPTER 7: APPENDIX
// ============================================================
body.AppendChild(ColorBlock("第七章  附  录", colorAccent, "FFFFFF", "28"));
body.AppendChild(BodyPara(""));
...
afRPr.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
...
cpRPr.AppendChild(new RunFonts { EastAsia = "Microsoft YaHei", Ascii = "Arial", HighAnsi = "Arial" });
